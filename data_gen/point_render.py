...
if __name__ == "__main__":
    ...
    argparser.add_argument("--data_dir", type=str, default="/mnt/petrelfs/huangsiyuan/data/partnet-mobility-v0")
    argparser.add_argument("--data_name", type=str, default="8930")
    argparser.add_argument("--output_dir", type=str, default="/mnt/petrelfs/huangsiyuan/data/partnet_pyrender_960_v6_fix_angle")

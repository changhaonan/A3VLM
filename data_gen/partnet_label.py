...
if __name__ == "__main__":
    ...
    argparser.add_argument("--data_dir", type=str, default="/mnt/petrelfs/huangsiyuan/data/partnet-mobility-v0", help="Path to the original dataset")
    argparser.add_argument("--output_dir", type=str, default="/mnt/petrelfs/huangsiyuan/data/partnet_pyrender_960_v6_fix_angle", help="Path to the rendering output folder")
    argparser.add_argument("--grounding_dataset_folder", type=str, default="/mnt/petrelfs/huangsiyuan/PartNetRender/openai_grounding_tasks", help="Path to the grounding dataset folder")
    argparser.add_argument("--vqa_tasks_folder", type=str, default="/mnt/petrelfs/huangsiyuan/data/ManipVQA2/vqa_tasks_v5", help="Path to the VQA tasks folder")
    argparser.add_argument("--classname_file", type=str, default="/mnt/petrelfs/huangsiyuan/PartNetRender/partnet_pyrender_dataset_v3_classname.json", help="Path to the class name file")
